...
#//[SM31][RaymondLin] LCM driver porting begin
BOOT_LOGO = hd720
#//[SM31][RaymondLin] LCM driver porting end
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_MTK_SDK =
BUILD_PRELOADER = yes
BUILD_UBOOT = no
#//<2016/10/14-QuakenTsai, Google GMS enable
BUILD_GMS = yes
#//>2016/10/14-QuakenTsai
CUSTOM_BUILD_VERNO =
...
# [SM31][Camera]Add Camera OTP driver Person Liu 20161012 S
CUSTOM_HAL_CAM_CAL = s5k3l8_otp
# [SM31][Camera]Add Camera OTP driver Person Liu 20161012 E
CUSTOM_HAL_COMBO = mt6735
CUSTOM_HAL_EEPROM = dummy_eeprom
# [SM31][Camera][akenhsu] Add Flash LED IC: lm3648tt 20161003 BEGIN
CUSTOM_HAL_FLASHLIGHT = constant_flashlight
# [SM31][Camera][akenhsu] 20161003 END
# [SM31][Camera][akenhsu] Add Camera Sensor: s5k3l8 s5k5e2 20161021 BEGIN
CUSTOM_HAL_IMGSENSOR = s5k3l8_mipi_raw s5k3l8s_mipi_raw s5k3l8s2_mipi_raw s5k5e2ya_mipi_raw s5k5e2yb_mipi_raw
# [SM31][Camera][akenhsu] 20161021 END
# [SM31][Camera] Add Main Camera S5K3L8 person
CUSTOM_HAL_LENS = dw9714af dw9714taf dummy_lens
# [SM31][Camera] Add Main Camera S5K3L8 person
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9714af
# [SM31][Camera][akenhsu] Add Camera Sensor: s5k3l8 s5k5e2 20161021 BEGIN
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l8_mipi_raw s5k3l8s_mipi_raw s5k3l8s2_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9714af dw9714taf
# [SM31][Camera][akenhsu] 20161021 END
...
CUSTOM_HAL_SUB_IMGSENSOR = s5k5e2ya_mipi_raw s5k5e2yb_mipi_raw
# [SM31][Camera][akenhsu] 20161021 END
...
# [SM31][Camera]Add Camera OTP driver Person Liu 20161012 S
CUSTOM_KERNEL_CAM_CAL = s5k3l8_otp
# [SM31][Camera]Add Camera OTP driver Person Liu 20161012 E
CUSTOM_KERNEL_CORE = src
CUSTOM_KERNEL_DCT = dct
CUSTOM_KERNEL_EEPROM = dummy_eeprom
CUSTOM_KERNEL_FLASHLIGHT = constant_flashlight
#<--[SM31][Sensors][JasonHsing] Disable GYROSCOPE feature 20161005 BEGIN --
CUSTOM_KERNEL_GYROSCOPE =
#-->[SM31][Sensors][JasonHsing] Disable GYROSCOPE feature 20161005 END --
...
# [SM31][Camera][akenhsu] Add Camera Sensor: s5k3l8 s5k5e2 20161021 BEGIN
CUSTOM_KERNEL_IMGSENSOR = s5k3l8_mipi_raw s5k3l8s_mipi_raw s5k3l8s2_mipi_raw s5k5e2ya_mipi_raw s5k5e2yb_mipi_raw
# [SM31][Camera][akenhsu] 20161021 END
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
# [SM31][Camera][akenhsu] Add Camera Sensor: s5k3l8 s5k5e2 20161021 BEGIN
CUSTOM_KERNEL_LENS = dw9714af dw9714taf dummy_lens
# [SM31][Camera][akenhsu] 20161021 END
...
# [SM31][Camera][akenhsu] Add Camera Sensor: s5k3l8 s5k5e2 20161021 BEGIN
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l8_mipi_raw s5k3l8s_mipi_raw s5k3l8s2_mipi_raw
# [SM31][Camera][akenhsu] 20161021 END
CUSTOM_KERNEL_MAIN_LENS = dw9714af dw9714taf
...
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k5e2ya_mipi_raw s5k5e2yb_mipi_raw
# [SM31][Camera][akenhsu] 20161021 END
CUSTOM_KERNEL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_TOUCHPANEL = GT1XX
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
CUSTOM_MODEM=arima6737_64_sm31_n_lwg_dsds_cotsx_moly0017
...
#<--[SM31][Backlight][RaymondLin]Disable MTK AAL feature BEGIN --
# MTK_AAL_SUPPORT is not support
#<--[SM31][Backlight][RaymondLin]Disable MTK AAL feature end --
MTK_ACMT_DEBUG = no
...
# /* --- [SM31][Audio][LuboLu] Enable dual-mic function 20161006 begin ---  */
MTK_AUDIO_MIC_INVERSE = no
# /* --- [SM31][Audio][LuboLu] Enable dual-mic function 20161006 end ---  */
...
#20170106 [WeiLin]Disable  MTK_BG_POWER_SAVING_SUPPORT & MTK_BG_POWER_SAVING_UI_SUPPORT begin
...
#20170106 [WeiLin]Disable  MTK_BG_POWER_SAVING_SUPPORT & MTK_BG_POWER_SAVING_UI_SUPPORT end
MTK_BIP_SCWS = yes
...
MTK_BRANCH = alps-mp-n0.mp1.tc9sp
...
MTK_BSP_PACKAGE = no
#2016.10.11 [BT]Enable aptx codec begin
#MTK_BT_BLUEDROID_A2DP_APTX = no
MTK_BT_BLUEDROID_A2DP_APTX = yes
#2016.10.11 [BT]Enable aptx codec end
...
MTK_BUILD_VERNO = alps-mp-n0.mp1.tc9sp-V1.171_arima37.64.sm31.n_P26
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
#//<2016/11/09-masonmau, [FP17983][FP20998]Enable Cause code 33 for Telcel.
...
MTK_CT4GREG_APP = no
#[SM31][DRM][HankLin] Disable MTK CTA Drm. Begin
MTK_CTA_SET = no
#[SM31][DRM][HankLin] Disable MTK CTA Drm. End
MTK_CTA_SUPPORT = no
...
MTK_FIRST_MD = 1
#[SM31][SIM][JasonY] SIM driver porting -BEGIN
MTK_FLIGHT_MODE_POWER_OFF_MD = no
#[SM31][SIM][JasonY] SIM driver porting -END
MTK_FLV_PLAYBACK_SUPPORT = no
MTK_FMRADIO_APP = yes
# [SM31][FM]FM radio for Mekong. 20161014 begin
MTK_FM_50KHZ_SUPPORT = yes
# [SM31][FM]FM radio for Mekong. 20161014 end
...
MTK_GPU_SUPPORT = yes
# [SM31][Audio][LuboLu] Enable HAC feature. 20161006 begin
MTK_HAC_SUPPORT = yes
# [SM31][Audio][LuboLu] Enable HAC feature. 20161006 end
...
MTK_ION_SUPPORT = yes
#//<2016/10/05-yaozongzhang, turn off ipo_setting(Quick boot)
MTK_IPO_SUPPORT = no
#//>2016/10/05-yaozongzhang, turn off ipo_setting(Quick boot)
MTK_IPTV_SUPPORT = no
...
MTK_IRTX_SUPPORT = no
#[SM31][Charging] Charging enable JEITA battery temperature check start
MTK_JEITA_STANDARD_SUPPORT = yes
#[SM31][Charging] Charging enable JEITA battery temperature check end
MTK_K64_SUPPORT=yes
...
#//<2016/01/06-jackliao, Correct to remove MTK original MiraVision
...
#//<2016/10/03-yaozongzhang [NFC] NXP PN553 Porting.
MTK_NFC_ADDON_SUPPORT = no
MTK_NFC_GSMA_SUPPORT = no
MTK_NFC_HCE_SUPPORT = no
MTK_NFC_MT6605 = no
#//<2016/10/04-yaozongzhang-[All][Main][NFC][FP12479] To implement Arima SmartcardService, and disable mediatek SmartcardService
MTK_NFC_OMAAC_SUPPORT = yes
#//>2016/10/04-yaozongzhang End
#//>2016/10/03-yaozongzhang End
MTK_NFC_SE_NUM = 7
#//<2016/10/03-yaozongzhang [NFC] NXP PN553 Porting.
MTK_NFC_SUPPORT = no
#//>2016/10/03-yaozongzhang End
#//<2016/10/04-yaozongzhang-[All][Main][NFC][FP12479] To implement Arima SmartcardService, and disable mediatek SmartcardService
# Use Arima Smartcard Service
...
#[SM31][DRM][HankLin] Disable MTK OMA Drm. Begin
MTK_OMADRM_SUPPORT = no
#[SM31][DRM][HankLin] Disable MTK OMA Drm. End
...
#[SM31][Partition]Modify partition as Sony PA3 start
MTK_PERSIST_PARTITION_SUPPORT = yes
#[SM31][Partition]Modify partition as Sony PA3 end
...
# [8100] Prevent CMCC-SIM causes MODEM crash max
MTK_PROTOCOL1_RAT_CONFIG = Lf/W/G
# [8100] Prevent CMCC-SIM causes MODEM crash max
MTK_PROTOCOL3_RAT_CONFIG = G
# [Arima_8100][bozhi_lin] set ac charging current to 1.5A and enable high voltage battery 20160923 begin
# MTK_PUMP_EXPRESS_SUPPORT = no
# [Arima_8100][bozhi_lin] 20160923 end
...
#//<2016/10/28-ericlin, To remove secro feature.
...
#[SM31][HuiWang][ViLTE not supported in SM31]
...
# [SM31 Pine]Enable SIP option Start
MTK_SIP_SUPPORT = yes
# [SM31 Pine]Enable SIP option End
...
#CREATE_PROJECT_INFO=20160907175730

# /* --- [SM31][camera][yutaozhang] add ot and arcsoft&&morpho begin ---  */
MTK_CAM_OT_SUPPORT = yes
USE_ARCSOFT = yes
USE_MORPHO = no
# /* --- [SM31][camera][yutaozhang] add ot and arcsoft&&morpho end ---  */

SONY_UKULELE_SUPPORT = no
SONY_S1_SUPPORT = yes
MTK_TC9_FEATURE = yes
MTK_USSI_SUPPORT = yes
#//<2016/12/13-jackliao, [OneSW]Add one software multi sim support
#One software multi sim
